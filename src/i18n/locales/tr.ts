...
export const tr: Messages = {
  ...
  auth: {
    ...
    resetLinkSent: 'Şifre yenileme bağlantısı gönderildi. E-postadaki link uygulamayı açar.',
    resetEmailRequired: 'Şifre sıfırlamak için e-posta adresini yaz.',
    recoveryExpired: 'Bu sıfırlama bağlantısı geçersiz veya süresi dolmuş. Yeni bir tane iste.',
    orDivider: 'veya',
  ...
  paywall: {
    ...
    benefitFortune: 'Fal ücretsiz kalır — günlük haklar sunucuda.',
