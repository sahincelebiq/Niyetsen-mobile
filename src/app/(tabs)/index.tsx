...
export default function ChatScreen() {
  ...
  // Klavye açılışında (ve yükseklik değişiminde) liste en son mesaja yumuşak
  // kayar. lift'e değil open/height'e bakılır: Android adjustResize'da lift 0
  // ölçülür ama liste yine de dibe inmelidir (ss-07: son mesaj altında kalıyordu).
  useEffect(() => {
    if (keyboard.open) {
      scrollToEnd(true);
    }
  }, [keyboard.open, keyboard.height, scrollToEnd]);
